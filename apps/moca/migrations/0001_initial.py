# Generated by Django 2.1.10 on 2019-10-20 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='messages', to='moca.Appointment')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mediaType', models.CharField(choices=[('application/pdf', 'pdf'), ('image/jpg', 'jpg'), ('image/png', 'png')], max_length=10)),
